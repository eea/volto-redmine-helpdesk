...
const HelpdeskView = (props) => {
  ...
  React.useEffect(() => {
    ...
    setTimeout(() => {
        const helpdesk_container = document.getElementById('helpdesk_ticket_container');
        ...
        message.outerHTML = "<span class='discreet note'><strong>Note</strong>: "
        ...
        form.children.container.insertBefore(policy, form.children.container.children.privacy_policy_fields);
        policy.outerHTML = "<p><span class='discreet'>* mandatory fields</span></p>";
        ...
        enquiry_field.innerHTML = '<p class="custom_field" data-error-key="Type of Enquiry" data-require="false">'
                        ...
                        + '</select></p>'
        let enquiry_values = ['', 'Research and scientific representatives', 'Students', 'Citizens', 'Media representatives, publishing houses and portals',
        ...
        form.children.container.children.custom_fields.insertBefore(enquiry_field, form.children.container.children.custom_fields.children.tracker_id);
        enquiry_field.outerHTML = enquiry_field.innerHTML;


        let topics_field = document.createElement("p");
        topics_field.innerHTML = '<p class="custom_field" data-error-key="Enquiry Topics" data-require="false">'
                          ...
                          + '</select></p>'
        let topics_values = ['', 'Agriculture', 'Air', 'Biodiversity and ecosystems', 'Chemicals',
        ...
        form.children.container.children.custom_fields.insertBefore(topics_field, form.children.container.children.custom_fields.children.tracker_id);
        topics_field.outerHTML = topics_field.innerHTML;

        form.children.container.insertBefore(document.querySelector(".frc-captcha"), form.children.container.children.submit_button)
    }, 1000);
